...
3. Aggregating by geographic variables also fails to produce even a single valid __scheme_management__ value for many __subvillages__ and most __wards__. At the __lga__ and __region__ levels we can generally find at least several valid values per __lga__ or __region__, though some __lga__'s contain only a single valid value.
