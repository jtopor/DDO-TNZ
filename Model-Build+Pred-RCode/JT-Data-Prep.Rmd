...
```{r}
# load sekhars binned data file
binned <- read.csv("c:/data/698/training_transformed.csv", header = TRUE, stringsAsFactors = FALSE)

# get a list of variable names
# colnames(binned)

# reduce columns by removing collinear variables: removes 176 columns as-is
# NOTE: wpt_name and quantity are both missing from binned/dummies

# no imputation has been applied to construction_year, public_meeting, permit
...
# add new variable to house imputed values
tanz_m$public_meeting_new <- tanz$public_meeting
...
```{r}
write.csv(tanz_m, file = "C:/data/698/tanz-imputations.csv", row.names = FALSE)
```
